...
\begin{alignat*}{2}
\sum{\vec{F}_i} &= \sum_{\substack{k=0\\k\neq i}}^n\frac{Gm_im_k}{\norm{\vec{r}_i-\vec{r}_k}^3}\qty(\vec{r}_i-\vec{r}_k)
...
\vec{a}_i &= \sum_{\substack{k=0\\k\neq i}}^n \frac{Gm_k}{\norm{\vec{r}_i-\vec{r}_k}^3}\qty(\vec{r}_i-\vec{r}_k) \eqtag{avec}
\end{alignat*}
...
\[
\vec{a}_i = \sum_{\substack{k=0\\k\neq i}}^n 4\pi^2\frac{m_k}{M_\odot}\frac{\vec{r}_i-\vec{r}_k}{\norm{\vec{r}_i-\vec{r}_k}^3}\cdot \SI{1}{\astronomicalunit\cubed\per\year\squared} \eqtag{avecast}
\]
