...
\end{itemize}
This gives a total of \[12n + 18n\qty(n-1) = 18n^2-6n\eqtag{eulerflops}\] FLOPs per time step.
...
\end{enumerate}
\end{itemize}
This gives a total of \[12n + 18n\qty(n-1) + 9n = 18n^2+3n\eqtag{verletflops}\] FLOPS per time step.
...
% \clearpage
% \lstinputlisting[language={C++},caption={cpp\_ui.cpp}]{cpp_ui.cpp}
%
% \clearpage
% \lstinputlisting[language={C++},caption={planet.h}]{planet.h}
%
% \clearpage
% \lstinputlisting[language={C++},caption={planet.cpp}]{planet.cpp}
%
% \clearpage
% \lstinputlisting[language={C++},caption={solarsystem.h}]{solarsystem.h}
%
% \clearpage
% \lstinputlisting[language={C++},caption={solarsystem.cpp}]{solarsystem.cpp}
